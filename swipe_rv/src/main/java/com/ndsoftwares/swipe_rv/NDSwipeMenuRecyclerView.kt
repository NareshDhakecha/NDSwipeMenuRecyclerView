package com.ndsoftwares.swipe_rv
...
private const val TAG = "NDSwipeMenuRecyclerView"

/**
 * Created by NARESH DHAKECHA on 2023/4/17.
 */
class NDSwipeMenuRecyclerView @JvmOverloads constructor(
    ...
    private fun findSwipeLayout(view: View): NDSwipeLayout? {
        if (view is NDSwipeLayout) {
            return view
        }
